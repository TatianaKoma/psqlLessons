-- 1. Выбрать все записи заказов ,
-- в которых наименование страны отгрузки начинается с 'U'
SELECT *
FROM orders
...
-- отсортировать по весу (по убыванию)
...
-- 3. Выбрать записи работников (включить колонки имени, фамилии, телефона, региона)
...
-- 5. Подсчитать кол-во поставщиков в каждой из стран
...
-- затем отфильтровать по суммарному весу
-- (вывести только те записи где суммарный вес больше 2750)
...
-- 7. Выбрать все уникальные страны заказчиков и поставщиков
...
-- 8. Выбрать такие страны
-- в которых "зарегистированы" одновременно и заказчики и поставщики и работники.
SELECT
    country
FROM customers
INTERSECT
